...
export const Dashboard: React.FC = () => {
        ...
        const data = [
            {
                ...
                percent: Number(percentGains.toFixed(1)) ? Number(percentGains.toFixed(1)) : 0,
                color: '#e2595c'
            },
            {
                name: 'Saídas',
                value: Number(totalExpenses),
                percent: Number(percentExpenses.toFixed(1)) ? Number(percentExpenses.toFixed(1)) : 0,
                color: '#e19a3b'
            }
        ]
    ...
    return (
        <C.Container>
            ...
            <C.Content>
                <WalletBox title={"saldo"} amount={totalBalance} footerlabel={"atualizado com base nas entradas e saídas"} icon={"dollarImg"} color={"#5d62ae"} />
                
                <WalletBox title={"entradas"} amount={totalGains} footerlabel={"atualizado com base nas entradas e saídas"} icon={"arrowUpImg"} color={"#5d62ae"} />
                
                <WalletBox title={"saídas"} amount={totalExpenses} footerlabel={"atualizado com base nas entradas e saídas"} icon={"arrowDownImg"} color={"#5d62ae"} />
                ...
                <HistoryBox 
                data={historyData}
                lineColorAmountInput={"#e19a3b"} lineColorAmountOutput={"#e19a3b"}
                />
